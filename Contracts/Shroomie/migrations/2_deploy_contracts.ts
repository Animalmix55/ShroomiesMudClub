...
module.exports = (artifacts: Truffle.Artifacts, web3: Web3) => {
  ...
  return async (
    ...
    const signer = web3.eth.accounts.privateKeyToAccount(process.env.signer_private as string);
    ...
    deployer.deploy(ShroomiesContract, 8888, 8000, 4, new BN('380000000000000'), signer.address, now, muchLater, later);
  }
}
